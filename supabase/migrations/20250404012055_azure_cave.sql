/*
  # Enhance Book Trial Security

  1. Changes
    - Add device_info column to book_trials table
    - Update trial functions to handle device fingerprinting
    - Add function to detect trial abuse
    
  2. Security
    - Improve device identification
    - Prevent trial abuse across accounts
