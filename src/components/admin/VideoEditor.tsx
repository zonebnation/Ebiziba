...
interface VideoEditorProps {
  video: Reel;
  onSave: (video: Reel) => void;
  onCancel: () => void;
}

export const VideoEditor: React.FC<VideoEditorProps> = ({ video, onSave, onCancel }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (videoFile) {
        updates.video_url = await uploadFile(videoFile, 'videos');
      }

      if (thumbnailFile) {
        updates.thumbnail_url = await uploadFile(thumbnailFile, 'thumbnails');
      }
              ...
              <div>
                ...
                >
                  ...
                  <div className="text-sm text-center text-gray-500 dark:text-gray-400">
                    ...
                    <br />
                    <span className="text-xs">Optional - MP4, WebM or OGG (Max 100MB)</span>
                  </div>
                </button>
              </div>
